...
<document xmlns="https://iead.ittl.gtri.org/wr24/doc/2011-09-30-2258"
  ...
  [...]
    ...
    namespace <code>CT_NAMESPACE</code>) is termed the document's <em>effective
  ...
  <section>
    ...
    <section>
      ...
      <ul>
        ...
        reference <code>CT_NAMESPACE</code>.</p></li>
  ...
  <section>
    ...
    <rule>
      <p>Within a conformant document, every occurrence of the attribute
        <code>{CT_NAMESPACE}conformanceTargets</code> MUST be locally
    ...
    information item that has the namespace name <code>CT_NAMESPACE</code>, other than
    attribute <code>{CT_NAMESPACE}conformanceTargets</code>.</p></rule>
    </ruleSection>
    ...
    a value that has a namespace name of <code>CT_NAMESPACE</code>.</p></rule>
    </ruleSection>
    ...
    attribute <code>{CT_NAMESPACE}conformanceTargets</code> MUST be an absolute
  ...
  <section>
    ...
    <definition id="def-effective_conformance_targets_attribute" term="effective conformance targets attribute">
      ...
      attribute <code>{CT_NAMESPACE}conformanceTargets</code>, in document
      order.</p>
    </definition>
    ...
    <ol>
      ...
      <li>
        ...
        <blockquote>
          ...
          Targets Attribute Specification</em> Version RELEASE_VERSION, and MUST have an
